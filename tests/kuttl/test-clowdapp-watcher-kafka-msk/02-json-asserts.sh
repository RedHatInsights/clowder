...
sleep 5
kubectl get secret --namespace=test-clowdapp-watcher-kafka-msk test-clowdapp-watcher-kafka-msk-connect -o json > ${TMP_DIR}/test-clowdapp-watcher-kafka-msk-user
