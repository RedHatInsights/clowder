...
func (in *KafkaConfig) DeepCopyInto(out *KafkaConfig) {
	*out = *in
	...
	out.EphemManagedSecretRef = in.EphemManagedSecretRef
}
...
func (in *WebServices) DeepCopyInto(out *WebServices) {
	*out = *in
	...
	out.Metrics = in.Metrics
	in.WebServicesMetadata.DeepCopyInto(&out.WebServicesMetadata)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WebServicesMetadata) DeepCopyInto(out *WebServicesMetadata) {
	*out = *in
	if in.Annotations != nil {
		in, out := &in.Annotations, &out.Annotations
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WebServicesMetadata.
func (in *WebServicesMetadata) DeepCopy() *WebServicesMetadata {
	if in == nil {
		return nil
	}
	out := new(WebServicesMetadata)
	in.DeepCopyInto(out)
	return out
}
