...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WrappedDeploymentStatus) DeepCopyInto(out *WrappedDeploymentStatus) {
	*out = *in
	if in.App != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WrappedDeploymentStatus.
func (in *WrappedDeploymentStatus) DeepCopy() *WrappedDeploymentStatus {
	if in == nil {
		return nil
	}
	out := new(WrappedDeploymentStatus)
	in.DeepCopyInto(out)
	return out
}
