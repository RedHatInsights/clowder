...
require (
	...
	knative.dev/pkg v0.0.0-20251118173915-745990698d3c // indirect
	sigs.k8s.io/controller-runtime/tools/setup-envtest v0.0.0-20251118141543-8539590135ef // indirect
