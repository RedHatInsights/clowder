...
type FrontendConfig struct {
	// Chrome corresponds to the JSON schema field "chrome".
	Frontends map[string]string `json:"frontends"`
}
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *FrontendConfig) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if v, ok := raw["chrome"]; !ok || v == nil {
		return fmt.Errorf("field chrome: required")
	}
