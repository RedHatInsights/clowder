...
func (te *TestEnvironment) Start() {
	...
	te.Environment = &envtest.Environment{
	...
	te.Client, err = client.New(cfg, client.Options{Scheme: clientgoscheme.Scheme})
	...
	te.Context, te.StopController = context.WithCancel(context.Background())

	nsSpec := &core.Namespace{ObjectMeta: metav1.ObjectMeta{Name: "kafka"}}
	k8sClient.Create(te.Context, nsSpec)

	go Run(":8080", ":8081", false, testEnv.Config, te.Context, false)
}
