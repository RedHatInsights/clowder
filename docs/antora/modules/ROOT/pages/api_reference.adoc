...
| *`disabled`* __boolean__ | Disable reconciliation for this deployment
|===
...
| *`certMode`* __xref:{anchor_prefix}-github-com-redhatinsights-clowder-apis-cloud-redhat-com-v1alpha1-gatewaycertmode[$$GatewayCertMode$$]__ | Determines the mode of certificate generation, either self-signed or acme
