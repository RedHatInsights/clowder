...
| *`requirements`* __string__ | sets value passed to IQE '--requirements' arg
| *`requirementsPriority`* __string__ | sets value passed to IQE '--requirements-priority' arg
| *`testImportance`* __string__ | sets value passed to IQE '--test-importance' arg
|===
