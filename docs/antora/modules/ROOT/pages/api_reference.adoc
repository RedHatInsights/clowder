...
| *`deploymentStrategy`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.15/#deploymentstrategy-v1-apps[$$DeploymentStrategy$$]__ | DeploymentStrategy allws the deployment strategy to be set only if the deployment has no public service enabled
|===
