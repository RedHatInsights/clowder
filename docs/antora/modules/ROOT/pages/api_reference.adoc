...
|===
| Field | Description
| *`enabled`* __boolean__ | Enable the autoscaler feature
|===


[id="{anchor_prefix}-github-com-redhatinsights-clowder-apis-cloud-redhat-com-v1alpha1-autoscalerkeda"]
==== AutoScalerKeda 
...
| *`autoScalerKeda`* __xref:{anchor_prefix}-github-com-redhatinsights-clowder-apis-cloud-redhat-com-v1alpha1-autoscalerkeda[$$AutoScalerKeda$$]__ | AutoScaler defines the configuration for the auto scaler
