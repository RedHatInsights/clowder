...
| *`simpleHPAOptIn`* __boolean__ | Use the simple autoscaler. Note: this only works if autoScaler mode is "simple" for the ClowdEnv
|===
...
|===
| Field | Description
| *`mode`* __AutoScalerMode__ | The type of autoscaler to use: - (*_keda_*) -- Use keda as the autoscaler - (*_simple_*) -- Use Kubernetes simple HPA as the autoscaler - (*_none_*) -- No autoscaler is used
|===
...
| *`simpleAutoScaler`* __xref:{anchor_prefix}-github-com-redhatinsights-clowder-apis-cloud-redhat-com-v1alpha1-simpleautoscaler[$$SimpleAutoScaler$$]__ | 
...
[id="{anchor_prefix}-github-com-redhatinsights-clowder-apis-cloud-redhat-com-v1alpha1-simpleautoscaler"]
==== SimpleAutoScaler 
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-redhatinsights-clowder-apis-cloud-redhat-com-v1alpha1-simpleautoscaler[$$SimpleAutoScaler$$]
****
