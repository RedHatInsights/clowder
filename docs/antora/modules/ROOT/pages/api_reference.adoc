...
| *`headlessService`* __xref:{anchor_prefix}-github-com-redhatinsights-clowder-apis-cloud-redhat-com-v1alpha1-headlessservice[$$HeadlessService$$]__ | 
...
[id="{anchor_prefix}-github-com-redhatinsights-clowder-apis-cloud-redhat-com-v1alpha1-headlessservice"]
==== HeadlessService 
