...
[id="{anchor_prefix}-github-com-redhatinsights-clowder-apis-cloud-redhat-com-v1alpha1-appdeploymentstatus"]
==== AppDeploymentStatus 
...
[id="{anchor_prefix}-github-com-redhatinsights-clowder-apis-cloud-redhat-com-v1alpha1-envdeploymentstatus"]
==== EnvDeploymentStatus 
