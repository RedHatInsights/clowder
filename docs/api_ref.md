...
- [9. Property `root > kafka`](#kafka)
  - [9.1. Property `root > kafka > brokers`](#kafka_brokers)
    - [9.1.1. root > kafka > brokers > BrokerConfig](#autogenerated_heading_3)
      ...
      - [9.1.1.6. Property `root > kafka > brokers > brokers items > mtls`](#kafka_brokers_items_mtls)
        - [9.1.1.6.1. Property `root > kafka > brokers > brokers items > mtls > cacert`](#kafka_brokers_items_mtls_cacert)
        - [9.1.1.6.2. Property `root > kafka > brokers > brokers items > mtls > cert`](#kafka_brokers_items_mtls_cert)
        - [9.1.1.6.3. Property `root > kafka > brokers > brokers items > mtls > key`](#kafka_brokers_items_mtls_key)
        - [9.1.1.6.4. Property `root > kafka > brokers > brokers items > mtls > password`](#kafka_brokers_items_mtls_password)
      - [9.1.1.7. Property `root > kafka > brokers > brokers items > securityProtocol`](#kafka_brokers_items_securityProtocol)
...
| - [mtls](#kafka_brokers_items_mtls )                         | No      | object           | No         | In #/definitions/KafkaMTLSConfig | MTLS Configuration for Kafka                                                                                        |
...
##### <a name="kafka_brokers_items_mtls"></a>9.1.1.6. Property `root > kafka > brokers > brokers items > mtls`
...
| Property                                          | Pattern | Type   | Deprecated | Definition | Title/Description                                                                |
| ------------------------------------------------- | ------- | ------ | ---------- | ---------- | -------------------------------------------------------------------------------- |
| - [cacert](#kafka_brokers_items_mtls_cacert )     | No      | string | No         | -          | CA certificate trust list for validating client certs in PEM format (clients-ca) |
| - [cert](#kafka_brokers_items_mtls_cert )         | No      | string | No         | -          | Client certificate in PEM format                                                 |
| - [key](#kafka_brokers_items_mtls_key )           | No      | string | No         | -          | Client private key in PEM format                                                 |
| - [password](#kafka_brokers_items_mtls_password ) | No      | string | No         | -          | Password for client private key                                                  |

###### <a name="kafka_brokers_items_mtls_cacert"></a>9.1.1.6.1. Property `root > kafka > brokers > brokers items > mtls > cacert`
...
**Description:** CA certificate trust list for validating client certs in PEM format (clients-ca)

###### <a name="kafka_brokers_items_mtls_cert"></a>9.1.1.6.2. Property `root > kafka > brokers > brokers items > mtls > cert`
...
###### <a name="kafka_brokers_items_mtls_key"></a>9.1.1.6.3. Property `root > kafka > brokers > brokers items > mtls > key`
...
###### <a name="kafka_brokers_items_mtls_password"></a>9.1.1.6.4. Property `root > kafka > brokers > brokers items > mtls > password`
...
##### <a name="kafka_brokers_items_securityProtocol"></a>9.1.1.7. Property `root > kafka > brokers > brokers items > securityProtocol`
