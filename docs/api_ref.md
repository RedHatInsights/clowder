...
- [8. Property `root > metadata`](#metadata)
  ...
  - [8.3. Property `root > metadata > deployments`](#metadata_deployments)
    - [8.3.1. root > metadata > deployments > DeploymentMetadata](#autogenerated_heading_2)
...
- [9. Property `root > kafka`](#kafka)
  - [9.1. Property `root > kafka > brokers`](#kafka_brokers)
    - [9.1.1. root > kafka > brokers > BrokerConfig](#autogenerated_heading_3)
  ...
  - [9.2. Property `root > kafka > topics`](#kafka_topics)
    - [9.2.1. root > kafka > topics > TopicConfig](#autogenerated_heading_4)
  ...
  - [9.3. Property `root > kafka > mtls`](#kafka_mtls)
    - [9.3.1. Property `root > kafka > mtls > cacert`](#kafka_mtls_cacert)
    - [9.3.2. Property `root > kafka > mtls > userCert`](#kafka_mtls_userCert)
    - [9.3.3. Property `root > kafka > mtls > userKey`](#kafka_mtls_userKey)
    - [9.3.4. Property `root > kafka > mtls > userPassword`](#kafka_mtls_userPassword)
    - [9.3.5. Property `root > kafka > mtls > userPkcs12`](#kafka_mtls_userPkcs12)
  - [9.4. Property `root > kafka > sasl`](#kafka_sasl)
...
- [11. Property `root > objectStore`](#objectStore)
  - [11.1. Property `root > objectStore > buckets`](#objectStore_buckets)
    - [11.1.1. root > objectStore > buckets > ObjectStoreBucket](#autogenerated_heading_5)
...
- [14. Property `root > endpoints`](#endpoints)
  - [14.1. root > endpoints > DependencyEndpoint](#autogenerated_heading_6)
    ...
    - [14.1.7. Property `root > endpoints > endpoints items > apiPaths`](#endpoints_items_apiPaths)
      - [14.1.7.1. root > endpoints > endpoints items > apiPaths > apiPaths items](#autogenerated_heading_7)
- [15. Property `root > privateEndpoints`](#privateEndpoints)
  - [15.1. root > privateEndpoints > PrivateDependencyEndpoint](#autogenerated_heading_8)
...
| - [cloudwatch](#logging_cloudwatch ) | No      | object | No         | In #/definitions/CloudWatchConfig | Cloud Watch configuration                 |
...
#### <a name="autogenerated_heading_2"></a>8.3.1. root > metadata > deployments > DeploymentMetadata
...
| - [mtls](#kafka_mtls )       | No      | object | No         | In #/definitions/KafkaMTLSConfig           | Configuration to use for brokers using MTLS auth type                    |
| - [sasl](#kafka_sasl )       | No      | object | No         | Same as [sasl](#kafka_brokers_items_sasl ) | Configuration to use for brokers using SASL auth type                    |
...
| Each item of this array must be      | Description                         |
| ------------------------------------ | ----------------------------------- |
| [BrokerConfig](#kafka_brokers_items) | Kafka broker connection information |

#### <a name="autogenerated_heading_3"></a>9.1.1. root > kafka > brokers > BrokerConfig
...
**Description:** Kafka broker connection information
...
| - [cacert](#kafka_brokers_items_cacert )                     | No      | string           | No         | -                                | CA certificate trust list for broker in PEM format (cluster-ca). If absent, client should use OS default trust list |
| - [authtype](#kafka_brokers_items_authtype )                 | No      | enum (of string) | No         | -                                | Authentication method used by the broker                                                                            |
| - [sasl](#kafka_brokers_items_sasl )                         | No      | object           | No         | In #/definitions/KafkaSASLConfig | Configuration to use for brokers using SASL auth type. DEPRECATED, refer to 'sasl' field under kafkaConfig instead  |
...
**Description:** CA certificate trust list for broker in PEM format (cluster-ca). If absent, client should use OS default trust list
...
**Description:** Authentication method used by the broker
...
**Description:** Configuration to use for brokers using SASL auth type. DEPRECATED, refer to 'sasl' field under kafkaConfig instead
...
| - [securityProtocol](#kafka_brokers_items_sasl_securityProtocol ) | No      | string | No         | -          | Broker security protocol, expect one of either: SASL_SSL, SSL. DEPRECATED, refer to securityProtocol field in brokerConfig instead |
...
**Description:** Broker security protocol, expect one of either: SASL_SSL, SSL. DEPRECATED, refer to securityProtocol field in brokerConfig instead
...
#### <a name="autogenerated_heading_4"></a>9.2.1. root > kafka > topics > TopicConfig
...
### <a name="kafka_mtls"></a>9.3. Property `root > kafka > mtls`
...
| **Required**              | No                                                                        |
| **Additional properties** | [[Any type: allowed]](# "Additional Properties of any type are allowed.") |
| **Defined in**            | #/definitions/KafkaMTLSConfig                                             |

**Description:** Configuration to use for brokers using MTLS auth type

| Property                                    | Pattern | Type   | Deprecated | Definition | Title/Description                                                              |
| ------------------------------------------- | ------- | ------ | ---------- | ---------- | ------------------------------------------------------------------------------ |
| - [cacert](#kafka_mtls_cacert )             | No      | string | No         | -          | CA certificate trust list for validating user certs in PEM format (clients-ca) |
| - [userCert](#kafka_mtls_userCert )         | No      | string | No         | -          | User certificate in PEM format                                                 |
| - [userKey](#kafka_mtls_userKey )           | No      | string | No         | -          | User private key in PEM format                                                 |
| - [userPassword](#kafka_mtls_userPassword ) | No      | string | No         | -          | Password for private key                                                       |
| - [userPkcs12](#kafka_mtls_userPkcs12 )     | No      | string | No         | -          | User certificate and key in .p12 format                                        |

#### <a name="kafka_mtls_cacert"></a>9.3.1. Property `root > kafka > mtls > cacert`
...
**Description:** CA certificate trust list for validating user certs in PEM format (clients-ca)

#### <a name="kafka_mtls_userCert"></a>9.3.2. Property `root > kafka > mtls > userCert`
...
**Description:** User certificate in PEM format

#### <a name="kafka_mtls_userKey"></a>9.3.3. Property `root > kafka > mtls > userKey`
...
**Description:** User private key in PEM format

#### <a name="kafka_mtls_userPassword"></a>9.3.4. Property `root > kafka > mtls > userPassword`
...
#### <a name="kafka_mtls_userPkcs12"></a>9.3.5. Property `root > kafka > mtls > userPkcs12`
...
**Description:** User certificate and key in .p12 format

### <a name="kafka_sasl"></a>9.4. Property `root > kafka > sasl`
...
| **Required**              | No                                                                        |
| **Additional properties** | [[Any type: allowed]](# "Additional Properties of any type are allowed.") |
| **Same definition as**    | [sasl](#kafka_brokers_items_sasl)                                         |

**Description:** Configuration to use for brokers using SASL auth type
...
#### <a name="autogenerated_heading_5"></a>11.1.1. root > objectStore > buckets > ObjectStoreBucket
...
### <a name="autogenerated_heading_6"></a>14.1. root > endpoints > DependencyEndpoint
...
##### <a name="autogenerated_heading_7"></a>14.1.7.1. root > endpoints > endpoints items > apiPaths > apiPaths items
...
### <a name="autogenerated_heading_8"></a>15.1. root > privateEndpoints > PrivateDependencyEndpoint
